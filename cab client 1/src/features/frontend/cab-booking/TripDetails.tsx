...
const TripDetails: React.FunctionComponent<ITripDetailsProps> = (props) => {
  ...
  const { source, destination, pickupDate, distance, duration } =
      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          >
            ...
            <Box>
              <Button className={classes.customButton}>Continue</Button>
            </Box>
          </Box>
          ...
          >
            ...
            <Typography
              ...
              sx={{ fontWeight: "500" }}
            >
              {new Date(pickupDate).toLocaleTimeString()}
            </Typography>
          </Box>
          ...
          >
            ...
            <Typography
              ...
              sx={{ fontWeight: "500" }}
            >
              {Math.floor(duration / (60 * 60))} hours {duration % 60} mins
            </Typography>
          </Box>
          <Box
            sx={{
